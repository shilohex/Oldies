  ...
  return (
    <div className="body">
      <div class="relative py-3 sm:max-w-xl sm:mx-auto">
        <div class="relative px-4 py-10 bg-[#b3dee5] mx-8 md:mx-0 shadow-2xl  rounded-3xl sm:p-10">
          <div class="max-w-md mx-auto text-white">
            <div class="mt-5 grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div>
                <label
                  class="font-semibold text-sm text-black pb-1 block"
                  for="fullname"
                >
                  Full Name
                </label>
                <input
                  class="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full bg-white text-gray-800 focus:border-pry focus:ring-2 focus:ring-sec"
                  type="text"
                  id="fullname"
                />
              </div>
            ...
            <div class="flex justify-center items-center">
              <div>
                <button class="flex items-center justify-center py-2 px-20 bg-white hover:bg-[#f8e5c4] focus:ring-sec focus:ring-offset-pry text-black w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg">
                  <svg
                    viewBox="0 0 24 24"
                    height="25"
                    width="25"
            ...
            <div class="flex items-center justify-between mt-4">
              ...
              <a
                class="text-xs text-black uppercase dark:text-black hover:underline"
                href="#"
              >
